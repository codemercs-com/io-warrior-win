...
PID = 0x1506  #Producr-ID
T_INTERFACE = 1  # IO-Interface

# ========================================
# Search for Warrior100 and return 'path'
# for IO-Interface (interface 1)
# ========================================
print("Searching for IO-Warrior100")
...
if not target_device:
    print("No Warrior100 found")
    exit(1)

# ========================================
# Open HID and connect to KeyWarrior100
# ========================================
print(f"Connect to Warrior100 using interface {T_INTERFACE}...")
device = hid.device()
...
device.close()
print("Warrior100 interface closed/free")
