...
'IOW-Warrior by Synsirion
Public Const IOWKIT_PRODUCT_ID_IOW_SENSI1 As Long = &H158A
Public Const IOWKIT_PID_IOW_SENSI1 As Long = IOWKIT_PRODUCT_ID_IOW_SENSI1
...
' IO-Warrior 28
Public Const IOWKIT_PRODUCT_ID_IOW28 As Long = &H1504
Public Const IOWKIT_PID_IOW28 As Long = IOWKIT_PRODUCT_ID_IOW28

' IO-Warrior 28L
Public Const IOWKIT_PRODUCT_ID_IOW28L As Long = &H1505
Public Const IOWKIT_PID_IOW28L As Long = IOWKIT_PRODUCT_ID_IOW28L

' IO-Warrior 100
Public Const IOWKIT_PRODUCT_ID_IOW100 As Long = &H1506
Public Const IOWKIT_PID_IOW100 As Long = IOWKIT_PRODUCT_ID_IOW100

' Max number of pipes per IOW device
Public Const IOWKIT_MAX_PIPES As Long = 4

' pipe names
Public Const IOW_PIPE_IO_PINS As Long = 0
Public Const IOW_PIPE_SPECIAL_MODE As Long = 1
Public Const IOW_PIPE_I2C_MODE As Long = 2
Public Const IOW_PIPE_ADC_MODE As Long = 3
