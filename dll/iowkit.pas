...
const
  ...
  //IO-Warrior by Sensirion
  IOWKIT_PRODUCT_ID_IOW_SENSI1   = $158a;
  IOWKIT_PID_IOW_SENSI1		     = IOWKIT_PRODUCT_ID_IOW_SENSI1;
  ...
  // IO-Warrior 28
  IOWKIT_PRODUCT_ID_IOW28  = $1504;
  IOWKIT_PID_IOW28         = IOWKIT_PRODUCT_ID_IOW28;
  
  // IO-Warrior 28L
  IOWKIT_PRODUCT_ID_IOW28L  = $1505;
  IOWKIT_PID_IOW28L         = IOWKIT_PRODUCT_ID_IOW28L;
  
  // IO-Warrior 100
  IOWKIT_PRODUCT_ID_IOW100  = $1506;
  IOWKIT_PID_IOW100         = IOWKIT_PRODUCT_ID_IOW100; 
...
type
  ...
  PIOWKIT28_IO_REPORT = ^IOWKIT28_IO_REPORT;
  IOWKIT28_IO_REPORT = packed record
    ReportID: Byte;
    Bytes: array [0..3] of Byte;
  end;

  PIOWKIT28_SPECIAL_REPORT = ^IOWKIT28_SPECIAL_REPORT;
  IOWKIT28_SPECIAL_REPORT = packed record
    ReportID: Byte;
    Bytes: array [0..62] of Byte;
  end;
  
  PIOWKIT100_IO_REPORT = ^IOWKIT100_IO_REPORT;
  IOWKIT100_IO_REPORT = packed record
    ReportID: Byte;
    Bytes: array [0..11] of Byte;
  end;

  PIOWKIT100_SPECIAL_REPORT = ^IOWKIT100_SPECIAL_REPORT;
  IOWKIT100_SPECIAL_REPORT = packed record
    ReportID: Byte;
    Bytes: array [0..62] of Byte;
  end;
...
const
  ...
  IOWKIT28_IO_REPORT_SIZE = SizeOf(IOWKIT28_IO_REPORT);
  IOWKIT28_SPECIAL_REPORT_SIZE = SizeOf(IOWKIT28_SPECIAL_REPORT);
  IOWKIT100_IO_REPORT_SIZE = SizeOf(IOWKIT100_IO_REPORT);
  IOWKIT100_SPECIAL_REPORT_SIZE = SizeOf(IOWKIT100_SPECIAL_REPORT);
