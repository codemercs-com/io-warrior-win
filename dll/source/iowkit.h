...
#define IOWKIT_PRODUCT_ID_IOW_SENSI1  0x158a
#define IOWKIT_PID_IOW_SENSI1		 IOWKIT_PRODUCT_ID_IOW_SENSI1
...
#define IOWKIT_PID_IOW28			IOWKIT_PRODUCT_ID_IOW28

// IO-Warrior 28L
#define IOWKIT_PRODUCT_ID_IOW28L	0x1505
#define IOWKIT_PID_IOW28L			IOWKIT_PRODUCT_ID_IOW28L

//IO-Warrior 100
#define IOWKIT_PRODUCT_ID_IOW100	0x1506
#define IOWKIT_PID_IOW100			IOWKIT_PRODUCT_ID_IOW100

//Test-Warrior (Internal, IOW28 based)
#define IOWKIT_PRODUCT_ID_TW		0x15FF
#define IOWKIT_PID_TW				IOWKIT_PRODUCT_ID_TW
...
#define IOWKIT28_IO_REPORT_SIZE sizeof(IOWKIT28_IO_REPORT)
#define IOWKIT28_SPECIAL_REPORT_SIZE sizeof(IOWKIT28_SPECIAL_REPORT)
#define IOWKIT28_I2C_REPORT_SIZE sizeof(IOWKIT28_SPECIAL_REPORT)
#define IOWKIT28_ADC_REPORT_SIZE sizeof(IOWKIT28_SPECIAL_REPORT)

#define IOWKIT100_IO_REPORT_SIZE sizeof(IOWKIT100_IO_REPORT)
#define IOWKIT100_SPECIAL_REPORT_SIZE sizeof(IOWKIT100_SPECIAL_REPORT)
#define IOWKIT100_I2C_REPORT_SIZE sizeof(IOWKIT100_SPECIAL_REPORT)
#define IOWKIT100_ADC_REPORT_SIZE sizeof(IOWKIT100_SPECIAL_REPORT)
