...
#define IOWARRIOR_CUSTOM_LEVEL IOWARRIOR_ORIGINAL_ONLY
...
#define IOWARRIOR_NUM_CUSTOM_PIDS 0

// Custom IO-Warrior vendor & product IDs
// Please insert your VendorID here
#define IOWKIT_CUSTOM_VENDOR_ID    0x0000
...
#define IOWKIT_CUSTOM_PRODUCT_ID_1 IOWKIT_CUSTOM_PRODUCT_ID_UNUSED
#define IOWKIT_CUSTOM_PRODUCT_ID_2 IOWKIT_CUSTOM_PRODUCT_ID_UNUSED
#define IOWKIT_CUSTOM_PRODUCT_ID_3 IOWKIT_CUSTOM_PRODUCT_ID_UNUSED
...
#define IOWKIT_CUSTOM_PRODUCT_ID_1_KIND IOWARRIOR_KIND_UNUSED
#define IOWKIT_CUSTOM_PRODUCT_ID_2_KIND IOWARRIOR_KIND_UNUSED
#define IOWKIT_CUSTOM_PRODUCT_ID_3_KIND IOWARRIOR_KIND_UNUSED
